...
#
# block_diagram.tcl: Tcl script for re-creating project 'block_diagram'
#
# Generated by Vivado on Sun Dec 04 01:52:05 -03 2022
...
#
# 1. This project restoration tcl script (block_diagram.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/../../../ipcore/vivado/repository"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "block_diagram"
...
set script_file "block_diagram.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../ipcore/vivado/block_diagram"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ipcore/vivado/repository"]" $obj
...
set_property -name "top" -value "blocks_wrapper" -objects $obj
...
# Proc to create BD blocks
proc cr_bd_blocks { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name blocks
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins myalu_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins myalu_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins myalu_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myalu_0/S00_AXI/S00_AXI_reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.727758",
   "Default View_TopLeft":"0,-15",
...
preplace inst myalu_0 -pg 1 -lvl 3 -x 880 -y 140 -defaultsOSRD
...
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 440 250 770J
...
# End of cr_bd_blocks()
cr_bd_blocks ""
set_property REGISTERED_WITH_MANAGER "1" [get_files blocks.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files blocks.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse blocks.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../ipcore/vivado/block_diagram/block_diagram.gen/sources_1/bd/blocks/hdl/blocks_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse blocks.bd] -top]
